...
public class SQLAcces {
    ...
    public Propietario buscarPropietarioPorDNI(String dni) throws SQLException {
        ...
        try (Connection connection = SQLManager.getConnection();
            ...
            if (rs.next()) {
                ...
                p.setDireccion(rs.getString("Direcion")); // Ojo, en la BD está escrito "Direcion" sin 'c'
    ...
    public static void añadirPropietario(Propietario propietario) throws SQLException {
