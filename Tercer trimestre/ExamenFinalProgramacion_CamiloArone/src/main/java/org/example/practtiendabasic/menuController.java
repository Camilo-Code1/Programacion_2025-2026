...
;
    ...
    public void registerButtonOnAction(ActionEvent event) {
        cambiarPantalla(event, "registerPropietario.fxml");
    }
    ...
    public void buscarButtonOnAction(ActionEvent event) {
        cambiarPantalla(event, "TablePropietarios.fxml");
    }


    public void registerGastButtonOnAction(ActionEvent event) {
        cambiarPantalla(event, "registerMascota.fxml");
    }

    public void buscarGastButtonOnAction(ActionEvent event) {
        cambiarPantalla(event, "TableMascotas.fxml");
    }
    ...
    public void registerConsulButtonOnAction(ActionEvent event) {
        cambiarPantalla(event, "registerConsulta.fxml");
    }

    public void buscarConsulButtonOnAction(ActionEvent event) {
        cambiarPantalla(event, "TableConsultas.fxml");
    }
}