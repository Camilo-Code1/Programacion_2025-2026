...
public class supFormatos {
    ...
    public String obtenerTextoNoVacio(String mensaje, Scanner sc) {
        String entrada;
        do {
    ...
    public int obtenerEnteroValido(String mensaje, Scanner sc) {
        while (true) {
            System.out.println(mensaje);
    ...
    public double obtenerDoubleValido(String mensaje, Scanner sc) {
        while (true) {
            System.out.println(mensaje);
            String entrada = sc.nextLine();
